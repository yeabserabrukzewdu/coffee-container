...
const TRANSLATIONS = {
  en: {
    ...
    'hero.stage1Title': '1. Selected Red Cherries',
    'hero.stage1Text': 'Harvested by hand only when peak sugar-density levels are reached.',
    'hero.stage2Title': '2. Clean Wet Processing',
    'hero.stage2Text': 'De-pulped, fermented organically, and washed with high-purity natural spring waters.',
    'hero.stage3Title': '3. Sun-Dried Maturity',
    'hero.stage3Text': 'Slow-dried on raised bamboo tables, continuously rotated for flavor uniformity.',
  ...
  ar: {
    ...
    'hero.stage1Title': '١. كرزات بن حمراء منتقاة',
    'hero.stage1Text': 'تُحصد يدوياً بعناية فقط عند الوصول إلى المستويات القصوى من تركيز السكر الطبيعي.',
    'hero.stage2Title': '٢. معالجة رطبة نظيفة',
    'hero.stage2Text': 'تُزال القشرة وتُخمر عضوياً، ثم تُغسل بمياه الينابيع الطبيعية عالية النقاء.',
    'hero.stage3Title': '٣. تجفيف متقن تحت الشمس',
    'hero.stage3Text': 'تجفيف بطيء على أسرة الخيزران المرتفعة، مع تقليب مستمر لضمان تناسق وتجانس النكهة.',
